    ...
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined)  {
        if (sentJob == "police") {
          ...
          } else if (sentJob == "sahp") {
            applyCustomTheme(customThemes.sahp)
     ...
     /*  let fireCount = 0; */
      ...
      activeUnits.forEach((unit) => {
        ...
        if (PoliceJobs[unit.unitType] !== undefined) {
          ...
          } else if(unit.unitType == "sahp")  { sahpCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sahp">SAHP</div>`;
          } else if(unit.unitType == "sast")  { sastCount++;
            activeInfoJob = `<div class="unit-job active-info-job-sast">SAST</div>`;
          } else if(unit.unitType == "sapr")  { saprCount++;
